...
export default function SiteFooter() {
  ...
  return (
    <footer className="border-t border-gray-800/60 bg-gray-950 mt-auto" role="contentinfo">
      <div className="max-w-7xl mx-auto px-5 py-10">
        <nav className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8" aria-label="Footer navigation">
          {/* Brand */}
          <div>
            <Link href="/" className="flex items-center gap-3 shrink-0 select-none" aria-label="AMORA Home">
              {/* Axis Mark SVG Icon */}
