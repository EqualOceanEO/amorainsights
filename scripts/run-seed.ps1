...
('Humanoid Robots: China''s Manufacturing Bet', 'humanoid-robots-china-manufacturing-2026',
 ...
 'manufacturing', false, 'AMORA Research', ARRAY['humanoid-robots','unitree','robotics'], NOW() - INTERVAL '4 days',
 'STANDARD', 'APPROVED', 'G0', '[]'::JSONB),
('Industrial IoT Platform Wars: Siemens vs Chinese Champions', 'industrial-iot-platform-wars-2026',
 ...
 'manufacturing', true, 'AMORA Research', ARRAY['iiot','smart-factory','siemens','huawei'], NOW() - INTERVAL '12 days',
 'SENSITIVE_TECH', 'APPROVED', 'G1',
...
('Unitree Robotics', '宇树科技', 'manufacturing', 'Humanoid Robots', 'China''s leading quadruped and humanoid robot company.', 'CN', 'Hangzhou', 'Zhejiang', 2016, false, true, ARRAY['humanoid-robot','quadruped','factory-automation']),
('UBTECH Robotics', '优必选', 'manufacturing', 'Humanoid Robots', 'Pioneer in humanoid robotics, listed on HKEX.', 'CN', 'Shenzhen', 'Guangdong', 2012, true, true, ARRAY['humanoid-robot','hkex-listed','automotive']),
