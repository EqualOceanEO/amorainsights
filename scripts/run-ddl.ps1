...
$sqlFile = "c:\Users\51229\WorkBuddy\Claw\scripts\full-schema-ddl-only.sql"
...
Write-Host "Sending to Management API (timeout 120s)..."
...
try {
    ...
    if ($result.Length -gt 500) { $result = $result.Substring(0,500) + "..." }
