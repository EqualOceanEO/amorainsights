...
$url = "https://jqppcuccqkxhhrvndsil.supabase.co/rest/v1/companies?select=id,name,amora_total_score,amora_advancement_score,amora_mastery_score,amora_operations_score,amora_reach_score,amora_affinity_score&sub_sector=eq.Humanoid%20Robots"
